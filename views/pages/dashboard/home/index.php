                                ...
                                <div class="col-xl-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <p class="text-muted text-center w-75 mx-auto mt-4 mb-0">Magnis dis
                                                parturient montes
                                            ...
                                            <div class="row gx-4 mt-1">
                                                <div class="col-md-4">
                                                    <div class="mt-4">
                                                        ...
                                                        <p
                                                            class="text-muted mt-2 pt-2 mb-0 text-uppercase font-size-13 text-truncate">
                                                            E-Commerce
                                                        </p>
                                            ...
                                            <div class="table-responsive mt-3">
                                                <table class="table align-middle table-centered table-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0);" class="text-dark">Product
                                                                    Pending</a>
                                                            </td>
                                                            <td>17,351</td>
                                                            <td>2,123</td>
                                                            <td><span
                                                                    class="badge bg-subtle-primary text-primary font-size-11 ms-1"><i
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>3,652</td>
                                                            <td><span
                                                                    class="badge bg-subtle-danger text-danger font-size-11 ms-1"><i
                                                                        class="mdi mdi-arrow-down"></i> 14.6%</span>
                                                            </td>
                                                        </tr><!-- end -->
                                ...
                                <div class="card-body pt-2">
                                    <div class="table-responsive" data-simplebar style="max-height: 358px;">
                                        <table
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 20px;"><img src="<?php echo $base_url;?>/assets/images/users/avatar-4.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1">Glenn Holden</h6>
                                                        <p class="text-muted mb-0 font-size-14">glennholden@tocly.com
                                                        </p>
                                                    </td>
                                                    <td class="text-muted"><i
                                                            class="mdi mdi-trending-up text-success font-size-18 align-middle me-1"></i>$250.00
                                                    </td>
                                                    <td><span class="badge badge-soft-danger font-size-12">Cancel</span>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-5.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1">Lolita Hamill</h6>
                                                        <p class="text-muted mb-0 font-size-14">lolitahamill@tocly.com
                                                        </p>
                                                    </td>
                                                    <td class="text-muted"><i
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-6.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1">Robert Mercer</h6>
                                                        <p class="text-muted mb-0 font-size-14">robertmercer@tocly.com
                                                        </p>
                                                    </td>
                                                    <td class="text-muted"><i
                                                            class="mdi mdi-trending-up text-success font-size-18 align-middle me-1"></i>$420.00
                                                    </td>
                                                    <td><span class="badge badge-soft-info font-size-12">Active</span>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                            <a class="text-muted dropdown-toggle font-size-20"
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-7.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-8.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1">Sonya Henshaw</h6>
                                                        <p class="text-muted mb-0 font-size-14">sonyahenshaw@tocly.com
                                                        </p>
                                                    </td>
                                                    <td class="text-muted"><i
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-2.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1">Marie Kim</h6>
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-1.jpg"
                                                            class="avatar-sm rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1">Sonya Henshaw</h6>
                                                        <p class="text-muted mb-0 font-size-14">sonyahenshaw@tocly.com
                                        ...
                                        <table class="table align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a href="javascript: void(0);" class="text-body">#MB2540</a>
                                                    </td>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-2.jpg"
                                                            class="avatar-xs rounded-circle me-2" alt="..."> Neal
                                                        Matthews</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge rounded badge-soft-success font-size-12">Completed</span>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="javascript: void(0);" class="text-body">#MB2541</a>
                                                    </td>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-3.jpg"
                                                            class="avatar-xs rounded-circle me-2" alt="..."> Jamal
                                                        Burnett</td>
                                                    <td>
                                                        <p class="mb-0">ar252xf658dd</p>
                                                    </td>
                                                    <td>
                                                        07 Oct, 2022
                                                    </td>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge rounded badge-soft-danger font-size-12">Cancel</span>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex gap-3">
                                                            <a href="javascript:void(0);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="javascript: void(0);" class="text-body">#MB2542</a>
                                                    </td>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-4.jpg"
                                                            class="avatar-xs rounded-circle me-2" alt="..."> Juan
                                                        Mitchell</td>
                                                    <td>
                                                        <p class="mb-0">op632xf223dd</p>
                                                    </td>
                                                    <td>
                                                        06 Oct, 2022
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="javascript: void(0);" class="text-body">#MB2543</a>
                                                    </td>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-5.jpg"
                                                            class="avatar-xs rounded-circle me-2" alt="..."> Barry Dick
                                                    </td>
                                                    <td>
                                                        <p class="mb-0">ty756xf985dd</p>
                                                    </td>
                                                    <td>
                                                        05 Oct, 2022
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="javascript: void(0);" class="text-body">#MB2544</a>
                                                    </td>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-6.jpg"
                                                            class="avatar-xs rounded-circle me-2" alt="..."> Ronald
                                                        Taylor</td>
                                                    <td>
                                                        <p class="mb-0">jf754xf431dd</p>
                                                    </td>
                                                    <td>
                                                        04 Oct, 2022
                                                    </td>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge rounded badge-soft-warning font-size-12">Shipping</span>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex gap-3">
                                                            <a href="javascript:void(0);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="javascript: void(0);" class="text-body">#MB2545</a>
                                                    </td>
                                                    <td><img src="<?php echo $base_url;?>/assets/images/users/avatar-7.jpg"
                                                            class="avatar-xs rounded-circle me-2" alt="..."> Jacob
                                                        Hunter</td>
                                                    <td>
                                                        <p class="mb-0">fd964xf467dd</p>
                                                    </td>
                                                    <td>
                                                        04 Oct, 2022
                                                    </td>

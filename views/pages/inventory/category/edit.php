...
<form action="<?php echo $base_url ?>/category/update" method="post" class="row g-3 needs-validation mt-5" novalidate="" enctype="multipart/form-data">
...
<div class="col-md-6">
	...
	<div class="col-12">
		<button class="btn btn-primary" name="btnUpdate" type="submit"><i class="bi bi-save"></i> Update_category
	</div>
</form>
</div>
</div>

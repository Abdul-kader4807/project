...
<div class="container">
	...
	<form action="<?php echo $base_url ?>/product/confirm_delete" method="post" class="row g-3 needs-validation mt-5" novalidate="" enctype="multipart/form-data">
		...
		<div class="col-md-6">
			<label for="validationCustom01" class="form-label"> Id <span style="color: red;">*</span></label>
			<input type="text" name="id" class="form-control" required="" placeholder="Product Name" value="<?php echo $product->id ?>">
			<div class="valid-feedback">Looks good!</div>
		</div>

		<div class="col-md-6">
			<label for="validationCustom01" class="form-label"> Name <span style="color: red;">*</span></label>
			<input type="text" name="name" class="form-control" required="" placeholder="" value="<?php echo $product->name ?>">
			<div class="valid-feedback">Looks good!</div>
		</div>
		...
		<div class="col-12">
			<button class="btn btn-primary" name="btnDelete" type="submit"><i class="bi bi-save"></i> Delete Product</button>
		</div>
	</form>
</div>
</div>

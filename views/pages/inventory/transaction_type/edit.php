...
<form action="<?php echo $base_url ?>/transaction_type/update" method="post" class="row g-3 needs-validation mt-5" novalidate="" enctype="multipart/form-data">
...
<div class="col-md-6">
    ...
    <div class="col-md-6">
		...
		value="<?php echo $transaction_type->created_at ?>">
		<div class="valid-feedback">Looks good!</div>
	</div>
    ...
    <div class="col-md-6">
		...
		value="<?php echo $transaction_type->updated_at ?>">
		<div class="valid-feedback">Looks good!</div>
	</div>
	...
	<div class="col-12">
		<button class="btn btn-primary" name="btnUpdate" type="submit"><i class="bi bi-save"></i> UpdateTransaction_
	</div>
</form>
</div>
</div>

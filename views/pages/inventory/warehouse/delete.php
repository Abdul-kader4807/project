<div class="container">
<a href="<?php echo $base_url ?>/warehouse/index" class="btn btn-success float-end">Go Back</a>



<form action="<?php echo $base_url ?>/warehouse/confirm_delete" method="post" class="row g-3 needs-validation mt-5" novalidate="" enctype="multipart/form-data">
...
<div class="col-md-6">
	...
	<div class="col-12">
		<button class="btn btn-primary" name="btnDelete" type="submit"><i class="bi bi-save"></i> Delete_Warehouse</button>
	</div>
</form>
</div>
</div>

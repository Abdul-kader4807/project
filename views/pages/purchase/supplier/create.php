...
<form action="<?php echo $base_url ?>/supplier/save" method="post" class="row g-3 needs-validation mt-5" novalidate="" enctype="multipart/form-data">
	...
	<div class="col-md-6">
		<label for="validationCustom01" class="form-label">Supplier Photo</label>

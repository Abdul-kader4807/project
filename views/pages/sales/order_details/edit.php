...
<form action="<?php echo $base_url ?>/order_details/update" method="post" class="row g-3 needs-validation mt-5" novalidate="" enctype="multipart/form-data">
...
<input type="hidden" name="id" class="form-control" required="" placeholder="" value="<?php echo $order_details->id ?>">
	...
	<div class="col-12">
		<button class="btn btn-primary" name="btnUpdate" type="submit"><i class="bi bi-save"></i> Order_details</button>
	</div>
</form>
</div>
</div>

...
<form action="<?php echo $base_url ?>/order/save" method="post" class="row g-3 needs-validation mt-5" novalidate="" enctype="multipart/form-data">

	
    <div class="col-md-6">
		<label for="validationCustom01" class="form-label"> Customers_id <span style="color: red;">*</span></label>
		<input type="number" name="customers_id" class="form-control" required="" placeholder="customers_id">
    ...
    <div class="col-md-6">
		...
		<input type="number" name="order_total" class="form-control" required="" placeholder="order_total">
		<div class="valid-feedback">Looks good!</div>
	</div>
    ...
    <div class="col-md-6">
		...
		<textarea name="shipping_address" id="description" class="form-control" rows="3" placeholder="shipping_address"></textarea>
		<div class="valid-feedback">Looks good!</div>
	</div>
    ...
    <div class="col-md-6">
		...
		<input type="number" name="paid_amount" class="form-control" required="" placeholder="paid_amount">
		<div class="valid-feedback">Looks good!</div>
	</div>
    ...
    <div class="col-md-6">
		...
		<input type="number" name="status_id" class="form-control" required="" placeholder="status_id">
		<div class="valid-feedback">Looks good!</div>
	</div>
    ...
    <div class="col-md-6">
		...
		<input type="datetime-local" name="order_date" class="form-control" required="" placeholder="order_date">
		<div class="valid-feedback">Looks good!</div>
	</div>
    ...
    <div class="col-md-6">
		...
		<input type="datetime-local" name="delivery_date" class="form-control" required="" placeholder="delivery_date" min="0" max="5">
		<div class="valid-feedback">Looks good!</div>
</div>
	...
	<div class="col-12">
		<button class="btn btn-primary" name="btnSubmit" type="submit"><i class="bi bi-save"></i> Order</button>
	</div>
</form>
</div>
</div>

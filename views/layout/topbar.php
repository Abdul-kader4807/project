                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="<?php echo $base_url;?>/assets/images/logo-dark.png" alt="logo-sm-dark" height="24">
                            </span>
                            <span class="logo-lg">
                                <img src="<?php echo $base_url;?>/assets/images/logo-sm-dark.png" alt="logo-dark" height="25">
                            </span>
                        </a>

                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="<?php echo $base_url;?>/assets/images/logo-light.png" alt="logo-sm-light" height="24">
                            </span>
                            <span class="logo-lg">
                                <img src="<?php echo $base_url;?>/assets/images/logo-sm-light.png" alt="logo-light" height="25">
                            </span>
                        </a>
                    </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-none d-sm-inline-block">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            ...
                            <img class="" src="<?php echo $base_url;?>/assets/images/flags/bangladesh.png" alt="Header Language" height="16">
                        </button>
